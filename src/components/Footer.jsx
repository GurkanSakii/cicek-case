  ...
  return (
    <footer className="footer">
      <div className="footer-top">
        <div className="footer-left">
          ...
          <p className="kvkk">
            ...
            Korunması Kanunu kapsamında oluşturduğumuz aydınlatma metnine buradan ulaşabilirsiniz.
          </p>
        </div>
      ...
      <div className="footer-text">
        <p>
          Türkiyenin en büyük online çiçek sitesi ÇiçekSepeti ile sevdiklerinizi mutlu etmek çok kolay! Çiçek
